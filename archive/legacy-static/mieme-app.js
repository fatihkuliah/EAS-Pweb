const MieME = (() => {
  const menus = [
    { id: 1, nama: 'Mie Spesial Sambal Matah', kategori: 'Makanan', deskripsi: 'Mie signature dengan sambal matah segar dan racikan rempah khas MieME.', gambar: 'img/mie1.png', harga: 28000, porsi: '1 Orang', waktu: '25 Menit' },
    { id: 2, nama: 'Mie Signature', kategori: 'Makanan', deskripsi: 'Menu andalan dengan rasa autentik, gurih, dan tekstur mie yang lembut.', gambar: 'img/mi2.png', harga: 28000, porsi: '1 Orang', waktu: '25 Menit' },
    { id: 3, nama: 'Mie Goreng Topping Istimewah', kategori: 'Makanan', deskripsi: 'Mie goreng lengkap dengan topping spesial untuk rasa yang lebih mantap.', gambar: 'img/mi3.png', harga: 30000, porsi: '1 Orang', waktu: '25 Menit' },
    { id: 4, nama: 'Mie Kuah Udang Spesial', kategori: 'Makanan', deskripsi: 'Mie kuah gurih dengan udang segar dan aroma laut yang menggugah selera.', gambar: 'img/mi-udang.png', harga: 35000, porsi: '1 Orang', waktu: '30 Menit' },
    { id: 5, nama: 'Mie Kuah Spesial', kategori: 'Makanan', deskripsi: 'Mie kuah hangat dengan bumbu spesial yang cocok dinikmati kapan saja.', gambar: 'img/mi-kuah-s.png', harga: 28000, porsi: '1 Orang', waktu: '25 Menit' },
    { id: 6, nama: 'Es Teh', kategori: 'Minuman', deskripsi: 'Teh dingin menyegarkan untuk menemani setiap menu MieME.', gambar: 'img/esteh.png', harga: 8000, porsi: '1 Gelas', waktu: '5 Menit' },
    { id: 7, nama: 'Es Buah Segar', kategori: 'Minuman', deskripsi: 'Potongan buah segar dengan kuah manis dingin yang menyegarkan.', gambar: 'img/esbuah.png', harga: 15000, porsi: '1 Gelas', waktu: '5 Menit' },
    { id: 8, nama: 'Es Jeruk', kategori: 'Minuman', deskripsi: 'Jeruk segar dingin dengan rasa manis dan asam yang pas.', gambar: 'img/esjeruk.png', harga: 10000, porsi: '1 Gelas', waktu: '5 Menit' },
  ];

...
const metodeQris = [{ nama: 'QRIS', logo: 'assets/images/payment/Logo_QRIS.svg', link: 'qris' }];
...
function renderPayment(target, data) {
  target.innerHTML = data
    .map(
      (item) => `
        <button class="payment-card" onclick="pilihPayment('${item.nama}', '${item.link || 'upload-payment'}')">
